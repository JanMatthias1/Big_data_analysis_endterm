# -*- coding: utf-8 -*-
"""Euler_HS22_BigData_Final_Project_JM_2.0.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ONyuoWqDykS-RT-JyCgaRJMNKFmXQWK1
...
The accuracy between the testing and train is very similar (0.8257 vs 0.8259), which is good. This also indicated that most likley there isn't any overfitting.
...
"""By optimising the parameters there is a slight change in accuracy in the test data set, from 0.82 to 0.83. Which is slightly better, this indicates that the initial hyperparameters were already pretty good. Age has become the most important feature, and obesity, ICU are also more important compared to the initial model.
