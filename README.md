...
When analysing the data with euler, it can be noted that the accuracy of the models diminish, which is interesting as I previously thought they would increase (more data, better prediction). 
